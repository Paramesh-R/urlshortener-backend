...
exports.activateAccount = async (req, res, next) => {
  ...
  try {
    ...
    if (activated_user) {
      ...
      return res.json({ success: true, message: "Account has been activated Already." });
    }
    ...
    console.log(user)
    if (!user) {
      console.log(`Activation token is invalid or has expired`);
      return res.json({ success: false, message: "Activation token is invalid or has expired" });
    }
